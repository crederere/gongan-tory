        ...
        <FadeIn>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-xl mx-auto mb-10">
            <a href={KAKAO_LINK} target="_blank" rel="noopener"
              className="flex items-center gap-4 p-5 rounded-2xl bg-[#FEE500] hover:brightness-[0.97] transition-all">
            ...
            <a href={`tel:${PHONE}`}
              className="flex items-center gap-4 p-5 rounded-2xl bg-white border border-n-100 hover:border-n-200 hover:shadow-sm transition-all">
              <div className="w-10 h-10 rounded-full bg-n-50 flex items-center justify-center flex-shrink-0">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-n-500">
